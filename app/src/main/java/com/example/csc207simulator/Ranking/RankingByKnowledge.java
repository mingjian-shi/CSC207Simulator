...
/**
 * The class is responsible for sorting ranking by knowledge.
 */
public class RankingByKnowledge implements RankingMethod {
    ...
    public class Sort implements Comparator<Account> {
        ...
        public int compare(Account a1, Account a2) {
            return a2.getPlayer().getKnowledge() - a1.getPlayer().getKnowledge();
        }
